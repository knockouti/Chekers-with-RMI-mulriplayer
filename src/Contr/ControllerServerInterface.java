...
public interface ControllerServerInterface extends Remote {
    ...
    public  void deletePlayer(PlayerInterface playerInterface) throws RemoteException;
    ...
    public void setPlayerAlghoritm() throws RemoteException;

    public void startAddPlayer() throws RemoteException;
